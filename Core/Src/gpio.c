...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, ADS_START_Pin|ADS_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ADS_RST_GPIO_Port, ADS_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : ADS_START_Pin ADS_CS_Pin */
  GPIO_InitStruct.Pin = ADS_START_Pin|ADS_CS_Pin;
